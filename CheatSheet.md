...
- [Table of Contents](#table-of-contents)
  - [Symfony](#symfony)
    ...
    - [lexik](#lexik)
    - [doctrine](#doctrine)
      - [drop and create databse](#drop-and-create-databse)
      - [generation de migration](#generation-de-migration)
      - [modifier / créer une entitée](#modifier--crer-une-entite)
      - [créer une entité doctrine](#crer-une-entit-doctrine)
      - [update DB from entities](#update-db-from-entities)
      - [How to Generate Entities from an Existing Database](#how-to-generate-entities-from-an-existing-database)
      - [Generating the Getters & Setters or PHP Classes](#generating-the-getters--setters-or-php-classes)
  - [UNIX](#unix)
  ...
  - [Mac Osx](#mac-osx)
    ...
    - [alias .bash_profile](#alias-bash_profile)
      - [ajout / modification](#ajout--modification)
  - [VueJS](#vuejs)
  - [Sécurité](#scurit)
    ...
    - [Nmap](#nmap)
    - [Outils](#outils)
      - [wmap dans metasploit](#wmap-dans-metasploit)
      - [ne fonctionne pas ?](#ne-fonctionne-pas-)
      - [xsstrike (fonctionne) :](#xsstrike-fonctionne-)
      - [openvas (fonctionne) :](#openvas-fonctionne-)
      - [zap (fonctionne) :](#zap-fonctionne-)
    - [sn1per (fonctionne bien) :](#sn1per-fonctionne-bien-)
      - [autres](#autres)
      - [Outils de test de sécurité online](#outils-de-test-de-scurit-online)
      - [snyk](#snyk)
      - [Liens utiles](#liens-utiles)
  - [SEO](#seo)
    - [Google Analytics dasn un email](#google-analytics-dasn-un-email)
